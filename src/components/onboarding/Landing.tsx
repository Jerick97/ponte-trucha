    ...
    <div className="ad-contenido pb-24">
      ...
      <div className="mx-auto max-w-6xl px-6 sm:px-10">
        ...
        <footer className="mt-24 flex flex-wrap items-center justify-between gap-4 border-t border-[var(--color-ad-borde)] pt-7 text-xs text-[var(--color-ad-texto-tenue)]">
          ...
          <div className="flex items-center gap-5">
            <a
              href="https://github.com/Jerick97/ponte-trucha"
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-1.5 transition-colors hover:text-[var(--color-ad-texto)]"
            >
              {/* Logo de GitHub inline: lucide-react retiro los iconos de marcas. */}
